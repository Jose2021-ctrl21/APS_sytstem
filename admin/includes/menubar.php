      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header">STAFF</li>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="user-sample.php"><i class="fa fa-circle-o"></i>IT department</a></li>
              <li><a href="user-sample.php"><i class="fa fa-circle-o"></i>HR department</a></li>
            </ul>
          </li>
